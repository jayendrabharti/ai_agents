...
const AgentCard = ({ agent }) => {
    ...
    return (
        <div
            key={agent.name}
            className="group flex flex-col bg-gray-800 rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl"
          >
            ...
            <div className="bg-gray-900/95 backdrop-blur-sm p-6 flex-1">
